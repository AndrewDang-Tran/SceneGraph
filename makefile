...
CXXFILES = VectorMath.c++ Vertex.c++ Face.c++ Node.c++ Light.c++ Transform.c++ Camera.c++ TransformNode.c++ Geom.c++ Loader.c++  AttributeNode.c++ CameraNode.c++ GeomNode.c++ LightNode.c++ ObjectNode.c++ SceneGraph.c++ Gui.c++
CXX = clang++ -std=c++11
